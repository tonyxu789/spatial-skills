...
var Pagination = {
    ...
    createHtml: function (pageIndex, recordCount, pageSize) {
        ...
        var pageCount = Math.ceil(recordCount / pageSize);  //total pages num
        ...
        html.push("<span class=\"total\">" + recordCount + " records in total</span>");
        if (pageIndex > 0) {
            html.push("<span class=\"previous\"><a href=\"javascript:;\" page= " + (pageIndex - 1) + " data-rec=\"pre page\"></a></span>");
        }
        else {
        ...
        if (pageIndex < pageCount - 1) {
            html.push("<span class=\"next\"><a href=\"javascript:;\" page=" + (pageIndex + 1) + " data-rec=\"next page\"></a></span>");
        }
        else {
            html.push("<span class=\"disable next\"></span>");
        }

        // html.push("<span class=\"total\">" + pageSize + "records in everypage</span>");
        html.push("<span class=\"total total_page\">" + pageCount + " pages in total</span>");
        html.push("<span class=\"page_jump\">to</span><input id='pageInput' class='pageInput' oldpage='' maxlength='" + pageCount + "' type='text' ><span class=\"page_jump\">page</span><button type='button' id='pagebtn' class='pagebtn'>YES</button>");
